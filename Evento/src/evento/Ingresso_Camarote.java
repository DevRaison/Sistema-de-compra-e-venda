...
public class Ingresso_Camarote {
     ...
     {
          //Se o Ingreso for camarote calcular valor único mais 60% do valor único.
          valor_calculado = valor_unico * 60 / 100;
          valor_calculado = valor_calculado + valor_unico;
          valor_total = "camarote" + "\nValor R$ " + df.format(valor_calculado);
          Imprimir_Valor();
     }
